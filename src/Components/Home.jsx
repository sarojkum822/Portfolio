  ...
  return (
    <div className='p-10 w-full flex justify-between'>
      <div className='w-[60%]'>
        ...
        <button onClick={handleDownload} className='mt-4 w-52 gap-8 rounded-3xl text-zinc-800 bg-sky-500 pl-2 pr-2 p-1 rounded-sm border-2 border-b-gray-700 transition-all ease-out hover:scale-110 flex gap-2'>Download Resume <span><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <button
          ...
          className="mt-4 text-zinc-800 bg-sky-500 p-1 rounded-sm border-2 w-52 gap-[9vh] rounded-3xl border-b-gray-700 hover:scale-105 flex gap-2"
        >
          Show Resume{' '}
          <span>
        ...
        <button className='w-52 bg-zinc-900 text-white flex items-center gap-2 p-1 pl-2 rounded-3xl mt-4 border transition-all ease-in-out hover:scale-105'>
