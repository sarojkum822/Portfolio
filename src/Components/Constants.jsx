...
export const AppText={
   hello:'Hello,',
   Iam:'I am ',
   SarojKumar:'Saroj Kumar',
   aboutMeDescripion:"Proficient in the MERN stack, I've actively participated in developing Full Stack Projects which demonstrate my ability to work effectively in both individual and collaborative settings.",
   about:"About",
   Me:"Me",
   Skills:'Skills & ',
   Experties:'Experties',
   ...
   Contact:'Contact ',
   Us:'Us',
   copywriteText:'Copyright by saroj_kumar_04'
...
export const skillsList=[
  ...
  
   {
       id:1,
       icon:"Git",
       logo:'https://www.biteinteractive.com/wp-content/uploads/2021/05/git-vs-github.png'
   },
  
   {
       id:1,
       icon:"MongoDb",
       logo:'https://www.desuvit.com/wp-content/uploads/2021/03/mongodb-icon.png'
   },
   {
       id:1,
       icon:"mysql",
   ...
   },
   {
       id:1,
       icon:"Node",
       logo:'https://miro.medium.com/v2/resize:fit:800/1*bc9pmTiyKR0WNPka2w3e0Q.png'
   },
